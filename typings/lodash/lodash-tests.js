...
result = _([1, 2.5, 3, 1.5, 2, 3.5]).uniq(function (num) {
    return this.floor(num);
}, Math).value();
...
result = _([1, 2.5, 3, 1.5, 2, 3.5]).unique(function (num) {
    return this.floor(num);
}, Math).value();
...
result = _.forEach({ name: 'apple', type: 'fruit' }, function (value, key) {
...
result = _.each({ name: 'apple', type: 'fruit' }, function (value, key) {
    console.log(value, key);
});
...
result = _.groupBy({ prop1: 4.2, prop2: 6.1, prop3: 6.4 }, function (num) {
    return Math.floor(num);
});
result = _.groupBy({ prop1: 4.2, prop2: 6.1, prop3: 6.4 }, function (num) {
    return this.floor(num);
...
result = _({ prop1: 4.2, prop2: 6.1, prop3: 6.4 }).groupBy(function (num) {
    return Math.floor(num);
}).value();
result = _({ prop1: 4.2, prop2: 6.1, prop3: 6.4 }).groupBy(function (num) {
    return this.floor(num);
...
result = _(stoogesAges).max(function (stooge) {
    return stooge.age;
});
...
result = _(stoogesAges).min(function (stooge) {
    return stooge.age;
});
...
result = _([1, 2, 3, 4, 5, 6]).reject(function (num) {
    return num % 2 == 0;
}).value();
...
result = _([1, 2, 3]).sortBy(function (num) {
    return Math.sin(num);
}).value();
result = _([1, 2, 3]).sortBy(function (num) {
    return this.sin(num);
...
(function (a, b, c, d) {
    return _(arguments).toArray().slice(1).value();
})(1, 2, 3, 4);
