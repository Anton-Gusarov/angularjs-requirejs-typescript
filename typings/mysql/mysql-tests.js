...
var s = connection.query("UPDATE posts SET title = :title", { title: "Hello MySQL" }).stream({ highWaterMark: 5 });
...
query.on('error', function (err) {
    ...
    connection.pause();
    var processRow = function (row, cb) {
        cb();
    };
...
//# sourceMappingURL=mysql-tests.js.map