...
describe("Jasmine jQuery extension", function () {
    it("Adds jQuery matchers", function () {
    ...
    it("Handles HTML Fixtures", function () {
    ...
    it("Handles Style Fixtures", function () {
    ...
    it("Handles JSON Fixtures", function () {
    ...
    describe("Event Spies", function () {
        it("First, spy on the event", function () {
            var spyEvent = spyOnEvent('#some_element', 'click');
            $('#some_element').click();
            expect('click').toHaveBeenTriggeredOn('#some_element');
            expect(spyEvent).toHaveBeenTriggered();
        });
        it("You can reset spy events", function () {
            var spyEvent = spyOnEvent('#some_element', 'click');
            $('#some_element').click();
            expect('click').toHaveBeenTriggeredOn('#some_element');
            expect(spyEvent).toHaveBeenTriggered();
        ...
        it("You can similarly check if triggered event was prevented", function () {
            var spyEvent = spyOnEvent('#some_element', 'click');
        ...
        it("You can also check if the triggered event was stopped", function () {
            var spyEvent = spyOnEvent('#some_element', 'click');
            $('#some_element').click(function (event) {
...
//# sourceMappingURL=jasmine-jquery-tests.js.map